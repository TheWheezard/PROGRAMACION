...
public class redCajerosSeguro {
    public static void main(String[] args) throws InterruptedException {
        cuentaCorrienteSeguro cuenta = new cuentaCorrienteSeguro("CUENTA1", 30000);
        ...
        for (int i = 0; i < depositos.length; i++) {
            depositos[i] = new cajeroSeguro(cuenta, 1, 3000);
        }
        ...
        for (int i = 0; i < reintegros.length; i++) {
            reintegros[i] = new cajeroSeguro(cuenta, 2, 6000);
        }
