...
private:
	...
	/*ENTRADA - SALIDA*/
	friend std::ostream& operator<<(std::ostream& os, const Cadena& c) noexcept;
	friend std::istream& operator>>(std::istream& is, Cadena& c)noexcept;
...
// Para P2 y ss
// Especializaci�n de la plantilla hash<T>para definir la
