...
*/
template<typename tCoste>
tCoste laberinto(GrafoP<tCoste> g, typename GrafoP<tCoste>::vertice origen, typename GrafoP<tCoste>::vertice destino, matriz<bool> paredes)
{
...
*/
template<typename tCoste>
tCoste TrenBus(GrafoP<tCoste> tren, GrafoP<tCoste> bus, tCoste taxi, typename GrafoP<tCoste>::vertice origen,
